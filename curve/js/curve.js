...
Curve.prototype.drawLineAlias = function () {
  ...
  tangleY.setAttribute('points', this.option.textSpace + ',-2 ' + (this.option.textSpace - this.option.xaliasWid) + ',' + this.option.xaliasLong + ' ' + (this.option.textSpace + this.option.xaliasWid) + ',' + this.option.xaliasLong);
...
Curve.prototype.drawText = function () {
  ...
  textOne.setAttribute('y', '' + (this.option.elHeight - this.option.textSpace + this.option.textSize + 10));
  ...
  textTwo.setAttribute('y', '' + (this.option.elHeight - this.option.textSpace + this.option.textSize + 10));
  ...
  textThree.setAttribute('x', '' + this.option.textSpace - 5);
